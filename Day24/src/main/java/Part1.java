...
public class Part1 {
    ...
    public static void main (String[] args) throws IOException{
        ...
        System.out.println("Remaining Immunity units: " + previousImmunityUnitTotal);
        System.out.println("Remaining Infection units: " + previousInfectionUnitTotal);
    ...
    private static void initialize() throws IOException {
        ...
        List<String> lines = Files.readAllLines(Paths.get("C:\\workspace\\AoC2018\\Java\\Day24\\src\\main\\resources\\input.txt"));
